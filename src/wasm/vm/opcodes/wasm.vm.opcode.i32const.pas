...
uses wasm.vm.io, wasm.types.leb128, wasm.types.builtin, wasm.types.stack;
...
begin
     {$IFDEF DEBUG_OUTPUT}
     wasm.vm.io.writestringln('[wasm.vm.opcodes.i32constop] I32ConstOp');
     {$ENDIF}
     ...
     if Context^.ExecutionState.Operand_Stack^.Full then begin
            wasm.vm.io.writestringln('[wasm.vm.opcodes.i32constop] I32ConstOp: Stack Overflow!');
