...
begin
     ...
     if b = 0 then begin
        wasm.vm.io.writestringln('[wasm.vm.opcodes] Trap: i32.div_s division by zero!');
        Context^.ExecutionState.Running := false;
     end else if (a = TWASMInt32($80000000)) and (b = -1) then begin
        wasm.vm.io.writestringln('[wasm.vm.opcodes] Trap: i32.div_s overflow!');
        Context^.ExecutionState.Running := false;
     end else
