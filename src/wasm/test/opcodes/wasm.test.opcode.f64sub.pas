...
begin
    ...
    wasm.vm.tick(ctx);
    assert_f64('3.0-1.0=2.0', popf64(ctx^.ExecutionState.Operand_Stack), 2.0);
    ...
    pushf64(ctx^.ExecutionState.Operand_Stack, 3.0);
    wasm.vm.tick(ctx);
    assert_f64('1.0-3.0=-2.0', popf64(ctx^.ExecutionState.Operand_Stack), -2.0);
    ...
    pushf64(ctx^.ExecutionState.Operand_Stack, 0.0);
    wasm.vm.tick(ctx);
    assert_f64('0.0-0.0=0.0', popf64(ctx^.ExecutionState.Operand_Stack), 0.0);
