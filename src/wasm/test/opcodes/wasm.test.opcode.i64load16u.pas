unit wasm.test.opcode.i64load16u;
...
begin
    test_begin('opcode.i64.load16_u');

    code[0] := $33; { i64.load16_u }
    code[1] := $00; { align }
    code[2] := $00; { offset }
    ...
    wasm.vm.tick(ctx);
    assert_i64('load16_u $FFFF = 65535', popi64(ctx^.ExecutionState.Operand_Stack), 65535);
