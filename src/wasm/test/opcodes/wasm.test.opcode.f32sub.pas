...
begin
    ...
    wasm.vm.tick(ctx);
    assert_f32('3.0-1.0=2.0', popf32(ctx^.ExecutionState.Operand_Stack), 2.0);
    ...
    pushf32(ctx^.ExecutionState.Operand_Stack, 3.0);
    wasm.vm.tick(ctx);
    assert_f32('1.0-3.0=-2.0', popf32(ctx^.ExecutionState.Operand_Stack), -2.0);
    ...
    pushf32(ctx^.ExecutionState.Operand_Stack, 0.0);
    wasm.vm.tick(ctx);
    assert_f32('0.0-0.0=0.0', popf32(ctx^.ExecutionState.Operand_Stack), 0.0);
