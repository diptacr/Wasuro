unit wasm.test.opcode.i64load8u;
...
begin
    test_begin('opcode.i64.load8_u');

    code[0] := $31; { i64.load8_u }
    code[1] := $00; { align }
    code[2] := $00; { offset }
    ...
    wasm.vm.tick(ctx);
    assert_i64('load8_u $FF = 255', popi64(ctx^.ExecutionState.Operand_Stack), 255);
