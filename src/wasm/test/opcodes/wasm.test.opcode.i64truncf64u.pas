unit wasm.test.opcode.i64truncf64u;
...
var
    ...
    nanBits : TWASMUInt64;
begin
    test_begin('opcode.i64.trunc_f64_u');
    ...
    code[0] := $B1;
    ctx := make_test_context(@code[0], 1);
    pushf64(ctx^.ExecutionState.Operand_Stack, 100.9);
    wasm.vm.tick(ctx);
    assert_i64('trunc(100.9)=100', popi64(ctx^.ExecutionState.Operand_Stack), 100);
    ...
    code[0] := $B1;
    ctx := make_test_context(@code[0], 1);
    pushf64(ctx^.ExecutionState.Operand_Stack, 1.0E20);
    wasm.vm.tick(ctx);
