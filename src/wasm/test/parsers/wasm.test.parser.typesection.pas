...
begin
    ...
    { Type 0 }
    assert_u32('Type[0]._type=$60', uint32(ctx^.Sections.TypeSection^.Types[0]._type), $60);
    assert_u32('Type[0].ParamCount=2', ctx^.Sections.TypeSection^.Types[0].ParamCount, 2);
    assert_u32('Type[0].Param[0]=vti32', uint32(ctx^.Sections.TypeSection^.Types[0].ParamTypes[0].ValueType), uint32(vti32));
    assert_u32('Type[0].Param[1]=vti32', uint32(ctx^.Sections.TypeSection^.Types[0].ParamTypes[1].ValueType), uint32(vti32));
    assert_u32('Type[0].ReturnCount=1', ctx^.Sections.TypeSection^.Types[0].ReturnCount, 1);
    assert_u32('Type[0].Return[0]=vti32', uint32(ctx^.Sections.TypeSection^.Types[0].ReturnTypes[0].ValueType), uint32(vti32));

    { Type 1 }
    assert_u32('Type[1]._type=$60', uint32(ctx^.Sections.TypeSection^.Types[1]._type), $60);
