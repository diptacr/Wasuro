...
uses
    types, wasm.types.heap, wasm.test.framework;
...
begin
    ...
    assert_u32('read_uint16 value', uint32(v16), $1234);
    ...
    { Test: write/read uint64 }
    ok := write_uint64(16, h, uint64($CAFEBABE12345678));
    assert_bool('write_uint64 success', ok, true);
    ok := read_uint64(16, h, @v64);
    assert_bool('read_uint64 success', ok, true);
    assert_u64('read_uint64 value', v64, uint64($CAFEBABE12345678));
